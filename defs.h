...
enum { EMPTY, wP, wN, wB, wR, wQ, wK, bP, bN, bB, bR, bQ, bK  }; // Ten cac quan co
enum { FILE_A, FILE_B, FILE_C, FILE_D, FILE_E, FILE_F, FILE_G, FILE_H, FILE_NONE }; // Vi tri cot cua ban co
enum { RANK_1, RANK_2, RANK_3, RANK_4, RANK_5, RANK_6, RANK_7, RANK_8, RANK_NONE }; // Vi tri hang cua ban co
...
enum { WKCA = 1, WQCA = 2, BKCA = 4, BQCA = 8 }; //Nhap thanh
